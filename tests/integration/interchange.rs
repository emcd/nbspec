...
pub const FIXTURE_ROOT: &str = "tests/fixtures/import-classic";
pub const ACTIVE_CHANGE: &str = "add-foo";
pub const ARCHIVE_CHANGE: &str = "legacy";

pub(crate) fn nbspec(fixture: &Fixture, arguments: &[&str]) -> Output {
...
pub(crate) fn link_fixture(fixture: &Fixture) -> PathBuf {
